use smithay::{
    ...
    wayland::shell::xdg::XdgPopupSurfaceData,
    wayland::shell::xdg::XdgShellHandler,
    wayland::shell::xdg::XdgShellState,
    desktop::find_popup_root_surface,
    desktop::get_popup_toplevel_coords,
...
impl XdgShellHandler for Smallvil {
    ...
    fn resize_request(
        &mut self, surface: ToplevelSurface, seat: wl_seat::WlSeat, serial: Serial,
...
fn check_grab(
    seat: &Seat<Smallvil>, surface: &WlSurface, serial: Serial,
